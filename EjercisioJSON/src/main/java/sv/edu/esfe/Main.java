...
// Deserializar encuesta
    Encuesta encuestaJSon = mapper.readValue(new File( "Encuesta.json"), Encuesta.class);
    System.out.println("Archivo JSON: Encuesta deserealizada");
    System.out.println("Id:" + encuestaJSon.Id);
    System.out.println("Titulo: " + encuestaJSon.Titulo);
    System.out.println("Fecha:" + encuestaJSon.Fecha);
    System.out.println("Preguntas" );
    for (Preguntas p : encuestaJSon.Preguntas) {
        System.out.println("Pregunta " + p.Id + " " + p.texto + " ");
        System.out.println(" | ¿Es Obligatoria:? " + p.EsObligatoria );
        System.out.println("Opciones");
        for(Opciones o: p.Opciones){
            System.out.println( o.Id +" "+ " "+ o.texto + " " + o.Seleccionada );
